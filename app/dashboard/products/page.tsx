...
export default function ProductsPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      snackbar.error('Не вдалося завантажити продукти');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreate = async (data: ProductFormData) => {
    try {
      ...
      snackbar.success('Продукт успішно створено');
      await loadData();
      ...
      if (error instanceof Error) {
        ...
        snackbar.error('Не вдалося створити продукт');
      }
    }
  };
  ...
  const handleUpdate = async (data: ProductFormData) => {
    ...
    try {
      ...
      snackbar.success('Продукт успішно оновлено');
      await loadData();
      setIsModalOpen(false);
      ...
      if (error instanceof Error) {
        ...
        snackbar.error('Не вдалося оновити продукт');
      }
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      snackbar.success('Продукт успішно видалено');
      await loadData();
    } catch (error) {
      ...
      if (error instanceof Error) {
        ...
        snackbar.error('Не вдалося видалити продукт');
      }
    } finally {
      setIsDeleting(null);
    }
